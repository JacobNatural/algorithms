...
import com.app.extension.numbers.sort.QuickSortExtension;
...
@ExtendWith(QuickSortExtension.class)
@RequiredArgsConstructor
public class QuickSortTest {

    private final QuickSort<Integer> quickSort;
    ...
    public void test1(){
        Assertions
                .assertThatThrownBy(
                        () -> quickSort.sort(null, Comparator.naturalOrder()))
    ...
    public void test2(){
        Assertions
                .assertThatThrownBy(
                        () -> quickSort.sort(List.of(), Comparator.naturalOrder()))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void test4(){
        Assertions
                .assertThat(
                        quickSort.sortNaturalOrder(numbers))
    ...
    public void test5(){
        Assertions
                .assertThat(
                        quickSort.sortReversOrder(numbers))
