...
public class DenominationsCalculateNominalsTest {
    ...
    public void test1(int payment) {
        Assertions
                .assertThatThrownBy(
                        () -> denominations.calculateNominals(payment, 100))
    ...
    public void test2(int price) {
        Assertions
                .assertThatThrownBy(
                        () -> denominations.calculateNominals(1, price))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void test3() {
        Assertions
                .assertThatThrownBy(
                        () -> denominations.calculateNominals(10, 30))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void test4() {
        Assertions
                .assertThatThrownBy(
                        () -> denominations.calculateNominals(1233, 31)
                )
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void test5(int payment, int price, List<Integer> exceptedNominals) {
        Assertions
                .assertThat(denominations.calculateNominals(payment, price))
