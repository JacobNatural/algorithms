...
import com.app.extension.numbers.gcd.GcdSubtractRecursionExtension;
...
@ExtendWith(GcdSubtractRecursionExtension.class)
@RequiredArgsConstructor
public class GcdSubtractRecursionValueTest {

    private final GcdSubtractRecursion gcdSubtractRecursion;

    @Test
    @DisplayName("When argument a is invalid")
    public void test1(){
        Assertions.assertThatThrownBy(() -> gcdSubtractRecursion.value(-2,4))
    ...
    public void test2(){
        Assertions.assertThatThrownBy(() -> gcdSubtractRecursion.value(4,-4))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void test3(int a, int b, int expected) {
        Assertions
                .assertThat(gcdSubtractRecursion.value(a,b))
                .isEqualTo(expected);
    }
